...
// MARKERS: AFRENIAN ARMY
// Markers seen by players in AFRENIAN ARMY slots.

	case "afr_army":
	{
		["GrpAFR_CO", 0, "CO", "ColorYellow"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_DC", 0, "DC", "ColorYellow"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_ASL", 0, "ASL", "ColorRed"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_A1", 1, "A1", "ColorRed"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_A2", 1, "A2", "ColorRed"] spawn fnc_folk_localGroupMarker;		
		["GrpAFR_A3", 1, "A3", "ColorRed"] spawn fnc_folk_localGroupMarker;		
		["GrpAFR_BSL", 0, "BSL", "ColorBlue"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_B1", 1, "B1", "ColorBlue"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_B2", 1, "B2", "ColorBlue"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_B3", 1, "B3", "ColorBlue"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_CSL", 0, "CSL", "ColorGreen"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_C1", 1, "C1", "ColorGreen"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_C2", 1, "C2", "ColorGreen"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_C3", 1, "C3", "ColorGreen"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_MMG1", 2, "MMG1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_MAT1", 3, "MAT1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_ST1",  4, "ST1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_HMG1",  2, "HMG1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_MTR1",  5, "MTR1", "ColorOrange"] spawn fnc_folk_localGroupMarker;		
		["GrpAFR_HAT1",  3, "HAT1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_SAM1",  3, "SAM1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_ENG1",  6, "ENG1", "ColorYellow"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_IFV1",  7, "IFV1", "ColorRed"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_IFV2",  7, "IFV2", "ColorBlue"] spawn fnc_folk_localGroupMarker;	
		["GrpAFR_IFV3",  7, "IFV3", "ColorGreen"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_TNK1",  7, "TNK1", "ColorRed"] spawn fnc_folk_localGroupMarker;	
		["GrpAFR_TH1",  8, "TH1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_TH2",  8, "TH2", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpAFR_AH1",  8, "AH1", "ColorRed"] spawn fnc_folk_localGroupMarker;
		["UnitAFR_CO_M", 0, "COM", "ColorBlack"] spawn fnc_folk_localSpecialistMarker;
		["UnitAFR_DC_M", 0, "DCM", "ColorBlack"] spawn fnc_folk_localSpecialistMarker;
		["UnitAFR_ASL_M", 0, "AM", "ColorBlack"] spawn fnc_folk_localSpecialistMarker;		
		["UnitAFR_BSL_M", 0, "BM", "ColorBlack"] spawn fnc_folk_localSpecialistMarker;
		["UnitAFR_CSL_M", 0, "CM", "ColorBlack"] spawn fnc_folk_localSpecialistMarker;
	};
