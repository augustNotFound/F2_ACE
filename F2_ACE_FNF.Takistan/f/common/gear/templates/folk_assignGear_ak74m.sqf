// F2 - Folk Assign Gear Script - AK-74Ms
...
_smg = "ACE_oc14"; _smgmag = "ACE_20Rnd_9x39_B_OC14";																								// Standard Submachine Gun/Personal Defence Weapon (Vehicle Crew, Aircraft Pilot, Submachinegunner)
...
_bagmedium = "ACE_Rucksack_EAST";		// 8+ slots																							// Backpack for assistant gunners (AAR, AMMG, AMAT, AHAT), so that they don't have to drop ammo themselves

// ====================================================================================

// UNIQUE, ROLE-SPECIFIC EQUIPMENT

_AR = "ACE_RPK74M"; _ARmag = "ACE_75Rnd_545x39_T_RPK";																						// Automatic Rifleman
...
_RAT = "ACE_RPG27"; _RATmag = "ACE_RPG27";																									// Rifleman AT
