// F2 - Folk Assign Gear Script - L85s (UKF)
// Uses UKF Weapons (addon)
...
_rifle = "ukf_L85A2"; _riflemag = "ACE_30Rnd_556x45_S_Stanag";																				// Standard Riflemen (Spotter, HMG Assistant Gunner, MMG Assistant Gunner, Assistant Automatic Rifleman, MAT Assistant Gunner, HAT Assistant Gunner, MTR Assistant Gunner, Rifleman)

_carbine = "ukf_L85A2"; _carbinemag = "ACE_30Rnd_556x45_S_Stanag"; 																			// Standard Carabineer (Medic, HMG Gunner, Rifleman (AT), Rifleman (AA), MAT Gunner, HAT Gunner, MTR Gunner, Carabineer)
...
_glrifle = "ukf_L85A2AG36_acog_fgrip_CQB"; _glriflemag = "ACE_30Rnd_556x45_S_Stanag"; _glmag = "1Rnd_HE_M203";								// Rifle with GL and HE grenades (CO, DC, FTLs)
