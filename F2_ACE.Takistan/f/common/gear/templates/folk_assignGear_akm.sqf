// F2 - Folk Assign Gear Script - AKM LOADOUT
...
_rifle = "ACE_AKM"; _riflemag = "ACE_30Rnd_762x39_S_AK47";																					// Standard Riflemen (Spotter, HMG Assistant Gunner, MMG Assistant Gunner, Assistant Automatic Rifleman, MAT Assistant Gunner, HAT Assistant Gunner, MTR Assistant Gunner, Rifleman)

_carbine = "ACE_AKMS"; _carbinemag = "ACE_30Rnd_762x39_S_AK47"; 																				// Standard Carabineer (Medic, HMG Gunner, Rifleman (AT), Rifleman (AA), MAT Gunner, HAT Gunner, MTR Gunner, Carabineer)
...
_glrifle = "ACE_AKM_GL"; _glriflemag = "ACE_30Rnd_762x39_S_AK47"; _glmag = "1Rnd_HE_GP25";													// Rifle with GL and HE grenades (CO, DC, FTLs)
...
_MAT = "RPG7V"; _MATmag1 = "ACE_PG7V_PGO7"; _MATmag2 = "ACE_PG7VR_PGO7";																	// Medium AT
...
// LOADOUT: RIFLEMAN (AT)	
	case "rat":
	{
		...
		_success = [_unit, _RATmag, 1] call ACE_fnc_PackMagazine;
