// F2 - Folk Assign Gear Script - AK107s, 2HEDPs
...
_baglarge =  "ACE_Rucksack_EAST"; 		// 12+ slots
...
_HMG = "ACE_KORDProxy";																									// Heavy MG (note: HMG is an assembled weapon, gunner carries weapon)
_HMGmount = "ACE_6T7TripodProxy";																													// Assistant Heavy MG (note: HMG is an assembled weapon, assistant carries bipod/tripd)

_RAT = "ACE_RPG22"; _RATmag = "PG7V";																											// Rifleman AT
